...
impl fmt::Display for TokenKind {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TokenKind::Belief => write!(f, "belief"),
            TokenKind::Capabilities => write!(f, "capabilities"),
            TokenKind::Constraints => write!(f, "constraints"),
            TokenKind::Stateless => write!(f, "stateless"),
            TokenKind::Stateful => write!(f, "stateful"),
            TokenKind::Singleton => write!(f, "singleton"),
            TokenKind::Orchestrate => write!(f, "orchestrate"),
            TokenKind::Fusion => write!(f, "fusion"),
