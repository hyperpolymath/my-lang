...
The *Duet* dialect enables collaborative human-AI pair programming
through session types, two-party protocols, and neurosymbolic
extensions.

=== Contents

[arabic]
. link:protocol-theory/[Protocol Theory] - Two-party communication
protocols
. link:session-types/[Session Types] - Typed communication channels
. link:collaboration/[Collaboration Semantics] - Human-AI interaction
model
...
Programming as musical duet: - *Human*: Provides intent, domain
knowledge, creativity - *AI*: Provides execution, patterns, optimization
...
* *Theorem 1 (Session Fidelity)*: Communication follows the declared
protocol
