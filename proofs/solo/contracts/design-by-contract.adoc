...
[arabic]
. *Static verification*: Check standard contracts with SMT solver
. *AI verification*: Check AI clauses via model invocation
. *Hybrid*: Combine static and AI results
...
AI checks provide high-probability guarantees when: 1. The AI model is
reliable for the domain 2. The natural language specification is
unambiguous 3. The context is sufficient for verification
