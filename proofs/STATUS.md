...
| Surface→core elaboration correctness (`me` → `solo`) | Coq **machine-checked** (`elab_data_check` data fragment + `me_wt_sound` universal linear-use, axiom-free, M1.1/M1.1b) — **overtakes AS** (solo-only; no `me`-like dialect, nothing analogous as surveyed (AS@main 2026-06-02)) | M1 |
