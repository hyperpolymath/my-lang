...
git clone https://github.com/hyperpolymath/mylang-playground.git cd
mylang-playground
...
toolbox create mylang-playground-dev toolbox enter mylang-playground-dev
...
mylang-playground/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
